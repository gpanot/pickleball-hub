...
const translations = {
  en: {
    ...
    scoreDuprLoading: "Rating data loading...",
    scoreDuprHaveRating: "have a DUPR rating —",
    ...
    scoreDuprPillCompetitive: "Competitive crowd",
    scoreDuprPillMixed: "Mixed levels",
    scoreDuprPillCasual: "Casual / social",
  ...
  vi: {
    ...
    scoreDuprPillCompetitive: "Nhiều người chơi cạnh tranh",
    scoreDuprPillMixed: "Nhiều trình độ",
    scoreDuprPillCasual: "Chơi xã giao / giao lưu",
