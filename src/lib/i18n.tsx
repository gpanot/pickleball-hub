...
const translations = {
  en: {
    ...
    shareSessionHubFooter: "Find more sessions: https://pickleball-hub-gules.vercel.app",
  ...
  vi: {
    ...
    shareSessionHubFooter: "Tìm thêm buổi chơi: https://pickleball-hub-gules.vercel.app",
