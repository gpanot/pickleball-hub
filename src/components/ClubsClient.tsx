...
// import { fetchPublicApiJson, readPublicApiCache } from "@/lib/public-api-cache" — superseded by server props; no /api/clubs fetch
...
import type { GetClubsListItem } from "@/lib/queries";
...
export type ClubRow = GetClubsListItem;
